...
import logo from "../images/menu4.png";
...
const Invoices = () => {
  ...
  const handleDowload = () => {
    ...
    html2canvas(input).then((canvas) => {
      ...
      pdf.addImage(inputData, "PNG", 0, 0, pdfWidth, 0);
    ...
    <>
      ...
      <div className="order-invoice my-5">
        <div className="row d-flex justify-content-center mb-5">
          <button onClick={handleDowload} className="btn btn-success col-md-5">
          ...
          <main>
            <table className="mt-5">
              ...
              <tbody>
                {orderItems?.map((item) => (
                  <tr>
                    <td className="service">{item?.producs}</td>
